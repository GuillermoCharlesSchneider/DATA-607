...
**Total AVERAGE Member is the  at a specific account / 365. 

This is to account for turnover. Take all the members who worked at location in 2023, Sum the Number of days worked by each employee, and divide by 365. This gives you a approximate "average roster size" for throughout all of 2023. Each member needs to be included, because each member has a oppurtunity to file a complaint while they work and are represented by the union, regardless of how short their work length
